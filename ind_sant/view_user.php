...
if (!isset($_SESSION["admin_user"])) {
  echo "<script>window.location.href = 'http://localhost/filemanagement/ind_sant/login.html';</script>";
...
<!-- 
     ...
     <?php
         require_once("include/connection.php");
            ...
            $query = "SELECT * FROM login_user WHERE carrera = 'Ingeniería Civil Industrial' AND sede = 'Sede Santiago'";
            $result=mysqli_query($conn,$query);
