...
if (!isset($_SESSION["admin_user"])) {
  echo "<script>window.location.href = 'localhost/filemanagement/info_sant/login.html';</script>";
 ...
 <table id="dtable" class = "table table-striped">
     ...
     <?php
         require_once("include/connection.php");
            ...
            $query = "SELECT * FROM login_user WHERE carrera = 'Ingeniería Civil Informática' AND sede = 'Sede Santiago'";
            $result=mysqli_query($conn,$query);
    ...
    <tr>
               ...
               <td astyle="text-align: center;"><?php echo $status; ?></td>
