...
if (!isset($_SESSION["admin_user"])) {
  echo "<script>window.location.href = 'http://localhost/filemanagement/ind_talca/login.html';</script>";
 ...
 <table id="dtable" class = "table table-striped">
     ...
     <?php
         require_once("include/connection.php");
            ...
            $query = "SELECT * FROM admin_login WHERE carrera = 'Ingeniería Civil Industrial' AND sede = 'Sede Talca'";
            $result = mysqli_query($conn, $query);
