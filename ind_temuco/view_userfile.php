...
<tbody>
    ...
    <tr>
        ...
        $query = mysqli_query($conn, "SELECT DISTINCT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_ind_temuco WHERE ADMIN_STATUS = 'Informatica' OR ADMIN_STATUS = 'Admin' ORDER BY NAME DESC") or die(mysqli_error($con));
