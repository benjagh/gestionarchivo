 ...
 <table id="dtable" class = "table table-striped">
     ...
     <?php
         require_once("include/connection.php");
            ...
            $query = "SELECT * FROM admin_login WHERE carrera = 'Ingeniería Civil Industrial' AND sede = 'Sede Temuco'";
            $result = mysqli_query($conn, $query);
...
<script>
 ...
 if(isset($_POST['edit2'])){
  ...
  echo "<script type = 'text/javascript'>alert('Editado con éxitos');document.location='view_admin.php'</script>";
