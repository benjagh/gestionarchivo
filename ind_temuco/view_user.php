...
if (!isset($_SESSION["admin_user"])) {
  echo "<script>window.location.href = 'localhost/filemanagement/ind_temuco/login.html';</script>";
...
if ($carrera != 'Ingeniería Civil Industrial' || $sede != 'Sede Temuco') {
...
function updateSedeOptions() {
        ...
        // Añadir la opción de "Sede Temuco" solo si la carrera seleccionada es "Ingeniería Civil Química"
 ...
 <table id="dtable" class = "table table-striped">
     ...
     <?php
         require_once("include/connection.php");
            ...
            $query = "SELECT * FROM login_user WHERE carrera = 'Ingeniería Civil Industrial' AND sede = 'Sede Temuco'";
            $result=mysqli_query($conn,$query);
          ...
          <tr>
               <td style="text-align: center;" width='20%'><?php echo  $fname; ?></td>
               <td style="text-align: center;"><?php echo $admin; ?></td>
               <td style="text-align: center;" width='20%'><?php echo $pass; ?></td>
...
<!-- <div class="text-center">
  <a href="" class="btn btn-default btn-rounded mb-4" data-toggle="modal" data-target="#modalRegisterForm">Launch
    ...
    <p>All right Reserved 2021&copy; <?php echo date('Y');?></p>
    </div>
    <!--/.Copyright-->
