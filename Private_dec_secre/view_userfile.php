...
<tbody>
    ...
    <tr>
        ...
        $query = mysqli_query($conn, "SELECT DISTINCT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_info_talca WHERE ADMIN_STATUS = 'Ingeniería Civil Informática' OR ADMIN_STATUS = 'Admin' ORDER BY NAME DESC") or die(mysqli_error($con));
