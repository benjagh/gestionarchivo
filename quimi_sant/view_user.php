...
if (!isset($_SESSION["admin_user"])) {
  echo "<script>window.location.href = 'localhost/filemanagement/quimi_sant/login.html';</script>";
...
$sedes = ["Sede Santiago"];
$carreras = ["Ingeniería Civil Química"];
 ...
 <table id="dtable" class = "table table-striped">
     ...
     <?php
         require_once("include/connection.php");
            ...
            $query = "SELECT * FROM login_user WHERE carrera = 'Ingeniería Civil Química' AND sede = 'Sede Santiago'";
            $result=mysqli_query($conn,$query);
