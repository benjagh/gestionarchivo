...
if (!isset($_SESSION["admin_user"])) {
  echo "<script>window.location.href = 'http://localhost/filemanagement/private_secre_estudio/index.html';</script>";
...
<div class="form-group">
    ...
    <!-- Las opciones se llenarán dinámicamente -->
                    ...
                    <button type="submit" class="btn btn-primary">Agregar Ramo</button>
                </form>
            </div>
        </div>
    </div>
