...
<body>
    ...
    $email = mysqli_real_escape_string($conn, $_SESSION['email_address']);

    $r = mysqli_query($conn, "SELECT * FROM login_user where id = '$email'") or die(mysqli_error($con));
    ...
    <nav class="mb-1 navbar navbar-expand-lg navbar-dark red fixed-top">
        <a class="navbar-brand" href="home4.php"><img src="js/img/autonoma.png" width="204px" height="87px"> SISTEMA DE GESTIÓN DE ARCHIVOS </a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown"
                        ...
                        <font color="white">Bienvenido!,</font> <?php echo ucwords(htmlentities($email)); ?> <i class="fas fa-user-circle"></i>
                    </a>
...
<div class="sidebar-fixed position-fixed">
    <div class="list-group list-group-flush">
        ...
        <a href="add_file4.php" class="list-group-item list-group-item-action waves-effect">
            <i class="fas fa-file-medical"></i> Agregar documentos
        </a>
        <a href="perfil4.php" class="list-group-item list-group-item-action waves-effect">
        ...
        <div class='col-md-12'>
                ...
                <div id="tablaRamos" style="display: none;">
                        ...
                        <tr>
                            ...
                            $query = mysqli_query($conn, "SELECT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_ind_temuco WHERE EMAIL = '$id' ORDER BY NAME DESC") or die(mysqli_error($conn));
...
document.getElementById('filtroRamo').addEventListener('change', function() {
    ...
    if(ramoId) {
        ...
        $.ajax({
            url: 'ruta4.php', // Especifica la ruta a tu archivo PHP
            type: 'POST',
            data: {
                ramoId: ramoId,
