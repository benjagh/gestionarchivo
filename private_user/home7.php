...
<div class="sidebar-fixed position-fixed">
    <div class="list-group list-group-flush">
        ...
        <a href="add_file7.php" class="list-group-item list-group-item-action waves-effect">
        ...
        <div class='col-md-12'>
                ...
                <div id="tablaRamos" style="display: none;">
                        ...
                        <tr>
                            ...
                            $query = mysqli_query($conn, "SELECT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_quimi_sant WHERE EMAIL = '$id' ORDER BY NAME DESC") or die(mysqli_error($conn));
...
document.getElementById('filtroRamo').addEventListener('change', function() {
    ...
    if(ramoId) {
        ...
        $.ajax({
            url: 'ruta7.php', // Especifica la ruta a tu archivo PHP
            type: 'POST',
            data: {
                ramoId: ramoId,
