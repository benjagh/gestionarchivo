...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <p class="btn btn-default pull-right"><b><font color="black">Bienvenido!,</b></font><font color="red"><?=$_SESSION['username']?></font></p>
          </div><!--/.nav-collapse -->
        </div>
      </div>
    </div>  <br>
    <div id="mainsection">
        <div class="main">
            <a href="addfile.php"><button class="btn btn-success"><i class="icon-upload icon-white"></i>Agregar archivo</button></a>
	    <hr>
		...
		<div class="form_head">BORRAR</div><br>
		<form method="post" action="">
		    <div class="control-group">
				<label class="control-label">¿Estás seguro de eliminar? <font color="red"><strong><?=$name?></strong></font> Esto eliminará totalmente el archivo de la base de datos. . </label>
		    </div>
		     <div class="controls">
				<button class="btn btn-primary" name="delete">BORRAR</button>
				<a href="home.php" type="reset" class="btn btn-warning">CANCELAR</a>
				<?php
