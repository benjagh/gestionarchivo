        ...
        <div class='col-md-12'>
                ...
                <div id="tablaRamos" style="display: none;">
                        ...
                        <tr>
                            ...
                            $query = mysqli_query($conn, "SELECT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_ind_talca WHERE EMAIL = '$id' ORDER BY NAME DESC") or die(mysqli_error($conn));
                            while ($file = mysqli_fetch_array($query)) {
                                ...
                                <td style=""><a href='downloads.php?file_id=<?php echo $id; ?>'><img src="img/download-icon.png" width="30px" height="30px" title="Descargar archivo"></a></td>
...
document.getElementById('filtroRamo').addEventListener('change', function() {
    ...
    if(ramoId) {
        ...
        $.ajax({
            url: 'ruta2.php', // Especifica la ruta a tu archivo PHP
            type: 'POST',
            data: {
                ramoId: ramoId,
