                    ...
                    <table id="dtable" class="table table-striped" style="">
                        ...
                        <tbody>
                            <tr>
                                ...
                                $query = mysqli_query($conn, "SELECT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_files WHERE ADMIN_STATUS = 'Ingeniería Civil Industrial' AND sede = 'Talca' GROUP BY NAME DESC") or die(mysqli_error($conn));
