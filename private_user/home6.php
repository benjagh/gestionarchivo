        ...
        <div class='col-md-12'>
                ...
                <div id="tablaRamos" style="display: none;">
                        ...
                        <tr>
                            ...
                            $query = mysqli_query($conn, "SELECT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_ind_sant WHERE EMAIL = '$id' ORDER BY NAME DESC") or die(mysqli_error($conn));
...
document.getElementById('filtroRamo').addEventListener('change', function() {
    ...
    if(ramoId) {
        ...
        $.ajax({
            url: 'ruta6.php', // Especifica la ruta a tu archivo PHP
            type: 'POST',
            data: {
                ramoId: ramoId,
