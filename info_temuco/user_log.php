...
<hr>
 ...
 <div class="col-md-12">
  ...
  <table id="dtable" class = "table table-striped" style="">
    ...
    <!-- <th>ID</th> -->
    <th style="text-align: center;">Usuario logeado</th>    
...
<tbody>
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $host; ?></td>
      <td style="text-align: center;"><?php echo $action; ?></td>
      <td style="text-align: center;"><?php echo $logintime; ?></td>
      <td style="text-align: center;"><?php echo $actions; ?></td>
      <td style="text-align: center;"><?php echo $logouttime; ?></td>
