...
<!-- 
    ...
    <a href="add_file.php"><button type="button" class="btn btn-success"><i class="fas fa-file-medical"></i>  Agregar archivo</button></a>
    </div>
...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_info_temuco group by NAME DESC") or die (mysqli_error($con));
      ...
      <td style="text-align: center;" width="30%"><?php echo  $name; ?></td>
