...
if (!isset($_SESSION["admin_user"])) {
  echo "<script>window.location.href = 'localhost/filemanagement/info_temuco/login.html';</script>";
...
if ($carrera != 'Ingeniería Civil Informática' || $sede != 'Sede Temuco') {
 ...
 <table id="dtable" class = "table table-striped">
     ...
     <?php
         require_once("include/connection.php");
            ...
            $query = "SELECT * FROM login_user WHERE carrera = 'Ingeniería Civil Informática' AND sede = 'Sede Temuco'";
            $result=mysqli_query($conn,$query);
