...
<!-- 
    ...
    <a href="add_document.php"><button type="button" class="btn btn-info"><i class="fas fa-chevron-circle-left"></i>  Documentos</button></a>
    </div>
...
<tbody>
    ...
    <tr>
        ...
        $query = mysqli_query($conn, "SELECT DISTINCT ID, NAME, SIZE, EMAIL, ADMIN_STATUS, TIMERS, DOWNLOAD FROM upload_info_temuco WHERE ADMIN_STATUS = 'Informatica' OR ADMIN_STATUS = 'Admin' ORDER BY NAME DESC") or die(mysqli_error($con));
